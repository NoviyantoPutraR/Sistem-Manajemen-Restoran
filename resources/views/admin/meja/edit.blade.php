                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('updateMeja', ['id' => $meja->id]) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="terakhir_kunjungan" class="form-control datepicker"
                                        ...
                                        value="{{ $meja->terakhir_kunjungan ? \Carbon\Carbon::parse($meja->terakhir_kunjungan)->format('Y-m-d') : '' }}">
                                </div>
