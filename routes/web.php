...
// //route untuk menampilkan view edit pelanggan
// Route::get('/admin/pelanggan/{pelanggan}/edit', 'PelangganController@edit')->name('editPelanggan');
// //route untuk menyimpan perubahan pelanggan, perhatikan bahwa fungsi routenya adalah post
// Route::post('/admin/pelanggan/{pelanggan}/edit', 'PelangganController@update')->name('updatePelanggan');
