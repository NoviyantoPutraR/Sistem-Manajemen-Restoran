        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('addUser') }}" class="btn btn-outline-info btn-fw"
                                style="margin-bottom: 10px;" role="button">Tambah User</a>                            
                            <div class="table-responsive">
                                <table class="table table-hover table-striped mx-auto">                               
                                    ...
                                    <tbody>
                                        @foreach ($tbl_users as $index => $tbl_user)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $tbl_user->name }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="confirmDelete(this)" data-url="{{ route('deleteUser', ['id' => $tbl_user->id]) }}" class="btn btn-gradient-danger btn-sm" type="button">Hapus</a>
                                                </td> 
                                            </tr>
                                        @endforeach
                                    </tbody>
