...
@section('addJavascript')
    ...
    <script>
        ...
        function calculateChange() {
            ...
            var harga_pesanan = document.getElementById("harga_pesanan").options[document.getElementById("harga_pesanan")
                .selectedIndex].value;
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="#" action="{{ route('daftarPesanan') }}" class="forms-sample"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="harga_pesanan" id="harga_pesanan" class="form-control" required>
                                        @foreach ($pesanans as $pesanan)
                                            <option value="{{ $pesanan->total_nominal }}">{{ $pesanan->total_nominal }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="tunai_set" id="tunai_set" class="form-control"
                                            step="0.01" required>
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-gradient-primary me-2"
                                                onclick="setTunai()">Set</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="tunai" id="tunai" class="form-control" step="0.01"
                                        oninput="pengurangan()" required>
                                </div>
                                ...
                                <button href="{{ route('daftarPesanan') }}"type="submit"
                                    class="btn btn-gradient-primary me-2">Bayar</button>
                            </form>
                        </div>
                    </div>
                </div>
