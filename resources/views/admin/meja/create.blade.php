                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('storeMeja') }}" class="forms-sample" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kapasitas" class="form-control" id="kapasitasMeja" placeholder="Masukkan Kapasitas Meja">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="terakhir_kunjungan" class="form-control datepicker" id="terakhirKunjungan" placeholder="Masukkan tanggal terakhir kunjungan">
                            </div>
